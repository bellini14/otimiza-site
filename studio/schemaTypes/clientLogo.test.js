...
describe('clientLogoType', () => {
  it('registers client logos with the approved sectors', () => {
    ...
    expect(fieldsByName.showOnNossaAbordagem.type).toBe('boolean')
    expect(fieldsByName.showOnNossaAbordagem.title).toBe('Aparece na pÃ¡gina Nossa abordagem?')
    expect(fieldsByName.showOnNossaAbordagem.initialValue).toBe(false)
